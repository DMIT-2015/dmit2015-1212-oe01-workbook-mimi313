package dmit2015.dmit20151212jsfdemo.model;
...
public interface WeatherService {
    ...
    @GET
    OpenWeatherData findByCityName(@QueryParam("q") String cityName, @QueryParam("appid") String apiKey, @QueryParam("unites") String units);

    @GET
    OpenWeatherData findByLocation(@QueryParam("lat") double latitude, @QueryParam("lon") double longitude, @QueryParam("appid") String apiKey, @QueryParam("unites") String units);
}
