...
//                .addAsLibraries(pomFile.resolve("groupId:artifactId:version").withTransitivity().asFile())
                ...
                .addAsLibraries(pomFile.resolve("org.hibernate:hibernate-core:5.3.24.Final").withTransitivity().asFile())
                .addAsLibraries(pomFile.resolve("org.hibernate.validator:hibernate-validator:6.2.1.Final").withTransitivity().asFile())
